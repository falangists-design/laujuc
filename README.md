...
pyinstaller --onefile --noconsole --name laujuc --icon laujuc/resources/laujuc_icon.ico --clean --noconfirm --collect-all PySide6 --collect-all shiboken6 --collect-submodules PySide6 --collect-submodules shiboken6 app.py
